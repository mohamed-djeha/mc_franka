...
struct PandaControlType<ControlMode::Position> : public franka::JointPositions
{
  ...
  franka::JointPositions update(const mc_rbdyn::Robot & robot, const rbd::MultiBodyConfig & mbc, size_t iter, size_t N, const std::array<double, 7>, const Eigen::Matrix<double, 7, 1>, double)
  {
...
struct PandaControlType<ControlMode::Velocity> : public franka::JointVelocities
{
  ...
  franka::JointVelocities update(const mc_rbdyn::Robot & robot, const rbd::MultiBodyConfig & mbc, size_t, size_t, const std::array<double, 7>, const Eigen::Matrix<double, 7, 1>, double)
  {
    const auto & rjo = robot.refJointOrder();
